...
if (tipo == "censos") {
  ...
  data_filt <- data_filt %>% 
    mutate (age_25_mas = ifelse(edad_ci>=25, 1, 0), 
           ...
           age_prim_c = case_when((pais_c=="COL"| pais_c=="BRA") & (edad_ci>=6 & edad_ci<=10) ~ 1, #SE ELIMINA CONDICION ASISTE CI PORQUE ESTO ES EDAD (SE PONE EN FUNCION)
                                  (pais_c=="COL"| pais_c=="BRA") & !(edad_ci>=6 & edad_ci<=10) ~ 0, #AGREGADO
                                  (pais_c=="BRB") & (edad_ci>=5&edad_ci<=10) ~ 1, #SE ELIMINA CONDICION ASISTE CI PORQUE ESTO ES EDAD (SE PONE EN FUNCION)
                                  (pais_c=="BRB") & !(edad_ci>=5&edad_ci<=10) ~ 0, #AGREGADO
                                  (pais_c=="TTO") & (edad_ci>=6&edad_ci<=12) ~ 1, #SE ELIMINA CONDICION ASISTE CI PORQUE ESTO ES EDAD (SE PONE EN FUNCION)
                                  (pais_c=="TTO") & !(edad_ci>=6&edad_ci<=12) ~ 0, #AGREGADO
                                  (edad_ci>=6 & edad_ci<=10)~ 1, #SE ELIMINA CONDICION ASISTE CI PORQUE ESTO ES EDAD (SE PONE EN FUNCION)
                                  !(edad_ci<6 & edad_ci>10) ~ 0, #AGREGADO
                                  TRUE ~ NA_real_),
           
           asis_net_prim_c = case_when((pais_c=="COL"|pais_c=="BRA") & (aedu_ci>=0 & aedu_ci<5) & (asiste_ci==1 & age_prim_c==1)~ 1, #SE USA SOLO PARA NUMERADOR POR TANTO ELIMINE LOS 0 QUE ESTABAN RARAS
           ...
           asis_net_seco_c = case_when((pais_c=="CRI"|pais_c=="GTM"|pais_c=="GUY"|pais_c=="JAM"|pais_c=="NIC"|pais_c=="PER"|pais_c=="VEN") & (aedu_ci>=6 & aedu_ci<11) & asiste_ci==1 & age_seco_c==1~ 1,#SE USA SOLO PARA NUMERADOR POR TANTO ELIMINE LOS 0 QUE ESTABAN RARAS
           ...
           asis_net_tert_c = case_when((pais_c=="COL"|pais_c=="CRI"|pais_c=="GTM"|pais_c=="GUY"|pais_c=="JAM"|pais_c=="NIC"|pais_c=="PER"|pais_c=="VEN") & aedu_ci>11 & asiste_ci==1 & age_tert_c==1 ~ 1, #SE USA SOLO PARA NUMERADOR POR TANTO ELIMINE LOS 0 QUE ESTABAN RARAS
