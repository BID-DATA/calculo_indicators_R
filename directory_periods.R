...
base <- paste("C:/Users/DCOR/OneDrive - Inter-American Development Bank Group/Documents/Indicadores encuestas de hogares/Indicadores/censos/clean/",pais,"/", pais,"_",anio, "_censusBID.dta",sep = "")  
